 ...
 */
 ...
 // PRODUCT QUICK VIEW FOR COLLECTION PAGES
     ...
     window.showSalesPopup = function (popUpIndexToDisplay) {
      let div = $jq321(".notifyjs-wrapper");
      if (div.length > 0) {
          return;
      }
 ...
 // ******************************************************************************************
     function visitorCounter(response) {
      let div = $jq321(".visitor-counter-content-box-carecartbysalespop-2020");
      if (div.length > 0) {
          return;
      }
 ...
 // ---------------------------------- <SOLD COUNTER MODULE> --------------------------------
     function soldCounter(response) {
      let div = $jq321(".sold-counter-content-box");
      if (div.length > 0) {
          return;
      }
 ...
 // ---------------------------------- </PRODUCT QUICK VIEW FOR COLLECTION PAGE> --------------------------------
     ...
     {
       let div = $jq321(".trust-badges-center");
     if (div.length > 0) {
         return;
     }
