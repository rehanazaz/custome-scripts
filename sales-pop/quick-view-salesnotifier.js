 ...
 */
 ...
 console.log(cc_product_id);
     ...
     if(Shopify.shop == "lady-lash.myshopify.com"){
        $jq321("head").append('<style type="text/css">.quick-shop-modal{top: 135px !important;} .quick-shop-addtocart button{margin-top: 10px !important; background-color: #Efe7da !important} .quickshop-quantity input{min-height: 30px  !important; border: 1px solid #Efe7da !important} .view-full-details a{color: #Efe7da !important} .quantity-button.quantity-up{border-color: #Efe7da !important;} .quantity-button.quantity-down{border-color: #Efe7da !important;}  </style>');
    }
